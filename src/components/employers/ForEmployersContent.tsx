...
const employerFeatures = [
  {
    ...
    description: "Publish as many positions as you need — no fees, no limits.",
  },
  {
    icon: Users,
    title: "Review Every Applicant",
    description: "See names and general location for all applicants the moment they apply.",
  },
  {
    icon: LayoutDashboard,
    title: "Manage Your Dashboard",
    description: "Track all listings and application statuses from one clean interface.",
  },
  {
    icon: FileDown,
    title: "Download Resumes",
    description: "Unlock full profiles and download resumes with a single click.",
  },
];
...
export default function ForEmployersContent() {
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0f2044] to-[#162d5f] dark:from-[#0e1a2e] dark:to-[#152237] text-white py-28 px-6">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6 tracking-tight text-white">
            Post Jobs Free. Unlock Talent When You&apos;re Ready.
          </h1>
          <p className="text-lg text-blue-200 dark:text-slate-400 max-w-xl mx-auto leading-relaxed mb-8">
            Create your employer account for free. Preview every applicant instantly.
            Pay only when you find someone worth pursuing.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="#pricing"
              className="inline-block px-8 py-3.5 text-sm font-semibold text-white border border-white/40 rounded-full hover:bg-white/10 transition-colors"
            >
              See Pricing ↓
            </a>
          </div>
      ...
      {/* Pricing Cards */}
      <section id="pricing" className="bg-white dark:bg-[#080e1c] py-20 px-6">
        <div className="max-w-5xl mx-auto">
